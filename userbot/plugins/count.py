...
async def stats(
    ...
    sky = await edit_or_reply(event, "`getting data from tele... BLACK PROCESSING.......`")
    ...
    response += (
        f"📌 **From The DataBase Of** :- [BLACK OFFICIAL](https://t.me/black_user_bot_B)"
    )
    await Black.edit(response)
